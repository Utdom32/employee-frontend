...
// //     const employeeList = await getEmployees(event.target.value);
// //     setEmployees(employeeList);
// //   };
// const handleDepartmentChange = async (event) => {
//     const selectedDepartment = event.target.value;
//     if (!selectedDepartment) {
//       // Reset everything when department is set to null/empty
//       setEmployees([]);
//       setSalary(initialEmployeeState);
...
//     setEmployees(employeeList);
//     setEmployee(initialEmployeeState); // Also reset employee form when department changes
//   };
